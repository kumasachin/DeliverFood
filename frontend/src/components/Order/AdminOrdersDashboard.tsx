  ...
  return (
    <Container maxWidth="xl" sx={{ py: 4 }}>
      ...
      <Box sx={{ display: "flex", gap: 2, mb: 3 }}>
        <DLSCard sx={{ flex: 1, p: 2 }}>
          <DLSTypography variant="h6" color="primary">
            Total Orders
          </DLSTypography>
          <DLSTypography variant="h4">{orders.length}</DLSTypography>
        </DLSCard>
        <DLSCard sx={{ flex: 1, p: 2 }}>
          <DLSTypography variant="h6" color="success">
            Total Revenue
          </DLSTypography>
          <DLSTypography variant="h4">
            {formatPrice(getTotalRevenue())}
          </DLSTypography>
        </DLSCard>
        <DLSCard sx={{ flex: 1, p: 2 }}>
          <DLSTypography variant="h6" color="warning">
            Active Orders
          </DLSTypography>
          <DLSTypography variant="h4">
            {getOrderCountForStatus(OrderStatus.PLACED) +
              getOrderCountForStatus(OrderStatus.PROCESSING) +
              getOrderCountForStatus(OrderStatus.IN_ROUTE)}
          </DLSTypography>
        </DLSCard>
      </Box>
